...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
                ...
                LogUri='s3://datalake-ney-cin-tf/emr-logs',
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-cin-tf/emr-code/pyspark/01_delta_spark_insert.py'
                                 ]
                    }
                },
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-cin-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                                 ]
                    }
                }],
            )
